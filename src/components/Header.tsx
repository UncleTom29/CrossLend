  ...
  return (
    <div className={`${className} fixed z-50 top-0 left-0 w-screen px-4 py-2 `}>
      ...
      <nav className="flex items-center flex-row w-full justify-between px-2 py-2 sm:px-4 h-full">
        {/* <img src="./wns-logo.png" width={200} height={30} className="object-cover p-0 ssm:block hidden"/>
        <img src="./wns-logo1.png" width={40} height={10} className="object-cover p-0 ssm:hidden block"/> */}
